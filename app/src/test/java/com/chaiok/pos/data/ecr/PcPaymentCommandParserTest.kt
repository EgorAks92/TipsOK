...
class PcPaymentCommandParserTest {
    ...
    @Test fun amdAmountRoundedScale0() { assertEquals("1500", PcPaymentCommandParser.parse("{\"proto\":\"chaiok-ecr\",\"version\":1,\"type\":\"payment\",\"amount\":\"1500.49\",\"currency\":\"AMD\"}".toByteArray())?.amount.toString()) }
